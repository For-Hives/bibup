import { ArrowRight, Calendar, CheckCircle, Clock, CreditCard, Instagram, Shield, Twitter, Users } from 'lucide-react'
						...
						<div className="flex flex-col items-start justify-between md:flex-row md:items-center">
							...
							<div className="flex flex-col space-y-2 md:flex-row md:space-y-0 md:space-x-8">
								<div className="flex space-x-6 text-sm">
									<Link className="text-gray-400 transition-colors hover:text-white" href="/race">
										Courses
									</Link>
									<Link className="text-gray-400 transition-colors hover:text-white" href="/calendrier">
										Calendrier
									</Link>
									<Link className="text-gray-400 transition-colors hover:text-white" href="/marketplace">
										Marketplace
									</Link>
									<Link className="text-gray-400 transition-colors hover:text-white" href="/faq">
										FAQ
									</Link>
									<Link className="text-gray-400 transition-colors hover:text-white" href="/contact">
										Contact
									</Link>
								</div>
								<div className="flex space-x-6 text-sm">
									<Link className="text-gray-500 transition-colors hover:text-gray-300" href="#">
										Confidentialité
									</Link>
									<Link className="text-gray-500 transition-colors hover:text-gray-300" href="#">
										Conditions
