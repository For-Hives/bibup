...
export default function AdminOrganizersPageClient({ translations, currentUser }: AdminOrganizersPageClientProps) {
	...
	const columns: ColumnDef<Organizer>[] = [
		...
		{
			size: 200,
			header: translations.organizers.table.columns.name,
		...
		{
			size: 180,
			header: translations.organizers.table.columns.email,
			cell: ({ row }) => {
		...
		{
			size: 120,
			header: translations.organizers.table.columns.partnership,
			cell: ({ row }: { row: Row<Organizer> }) => (
				<Badge variant={Boolean(row.getValue('isPartnered')) ? 'default' : 'secondary'}>
					{row.getValue('isPartnered')
						? translations.organizers.table.columns.status.partner
						: translations.organizers.table.columns.status.standard}
				</Badge>
			),
		...
		{
			size: 120,
			header: translations.organizers.table.columns.created,
			cell: ({ row }) => {
			...
			<div className="relative pt-32 pb-12">
				<div className="container mx-auto max-w-7xl p-6">
					<div className="space-y-8">
						{/* Header */}
						<div className="space-y-2 text-center">
							<h1 className="text-foreground text-4xl font-bold">{translations.organizers.title}</h1>
							<p className="text-muted-foreground text-lg">{translations.organizers.subtitle}</p>
						</div>
						...
						<div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-2">
							<Card className="border-border/50 bg-card/80 backdrop-blur-sm">
								<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
									<CardTitle className="text-sm font-medium">{translations.organizers.stats.totalOrganizers}</CardTitle>
							...
							<Card className="border-border/50 bg-card/80 backdrop-blur-sm">
								<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
									<CardTitle className="text-sm font-medium">
										{translations.organizers.stats.partneredOrganizers}
									</CardTitle>
						...
						<div className="mb-8">
							<div className="mb-6">
								<h2 className="text-foreground mb-2 text-2xl font-bold">Quick Actions</h2>
								<p className="text-muted-foreground">Common administrative tasks for organizer management</p>
							</div>
											...
											<div className="flex items-center gap-3">
												...
												<div>
													<CardTitle className="text-foreground group-hover:text-primary transition-colors">
														{translations.organizers.actions.createOrganizer}
													</CardTitle>
													<CardDescription className="text-muted-foreground">
														{translations.organizers.actions.createOrganizerDescription}
													</CardDescription>
												</div>
											</div>
										</CardHeader>
								...
								<div className="flex items-center gap-3">
									...
									<div className="relative">
										<Input
											...
											placeholder={translations.organizers.table.search}
											type="text"
												...
												<div className="flex flex-col gap-2 max-sm:items-center sm:flex-row sm:gap-4">
													...
													<AlertDialogHeader>
														...
														<AlertDialogDescription>
															...
															{table.getSelectedRowModel().rows.length === 1 ? 'organizer' : 'organizers'}.
														</AlertDialogDescription>
													</AlertDialogHeader>
												</div>
												<AlertDialogFooter>
												...
												<TableCell className="h-24 text-center" colSpan={columns.length}>
													<div className="text-center">
														<h3 className="text-foreground text-lg font-semibold">
															{translations.organizers.table.noResults}
														</h3>
														<p className="text-muted-foreground mb-4">
															{translations.organizers.table.noResultsDescription}
														</p>
														<Link href="/admin/organizer/create">
															<Button>{translations.organizers.actions.createOrganizer}</Button>
														</Link>
													</div>
												</TableCell>
											</TableRow>
