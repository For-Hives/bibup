			...
			<div className="from-background via-primary/5 to-background relative min-h-screen bg-gradient-to-br">
				...
				<div className="relative flex min-h-screen items-center justify-center">
					<div className="border-border/50 bg-card/80 w-full max-w-md rounded-3xl border p-8 text-center shadow-[0_0_0_1px_hsl(var(--border)),inset_0_0_30px_hsl(var(--primary)/0.1),inset_0_0_60px_hsl(var(--accent)/0.05),0_0_50px_hsl(var(--primary)/0.2)] backdrop-blur-md">
						...
						<p className="text-muted-foreground mb-6 text-lg">
							{translations.organizers.create.success.description.replace('{name}', createdOrganizer.name)}
						</p>
						<Button onClick={() => router.push('/admin')}>{translations.organizers.create.success.backButton}</Button>
					</div>
				</div>
			</div>
		)
	...
	return (
		<div className="from-background via-primary/5 to-background relative min-h-screen bg-gradient-to-br pt-24">
			...
			<div className="relative flex items-center justify-center p-6 md:p-10">
				<form
					className="border-border/50 bg-card/80 relative w-full max-w-2xl rounded-3xl border p-8 shadow-[0_0_0_1px_hsl(var(--border)),inset_0_0_30px_hsl(var(--primary)/0.1),inset_0_0_60px_hsl(var(--accent)/0.05),0_0_50px_hsl(var(--primary)/0.2)] backdrop-blur-md md:p-12"
					onSubmit={e => {
						e.preventDefault()
				...
				>
					...
					<div className="space-y-6">
						...
						<p className="text-muted-foreground text-sm">{translations.organizers.create.form.partnerDescription}</p>
					</div>

					{/* Form Actions */}
					<div className="flex items-center justify-end space-x-6 pt-8">
						<Button disabled={isLoading} onClick={handleCancel} size="lg" type="button" variant="outline">
