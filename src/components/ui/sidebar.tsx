...
>(({ onOpenChange: setOpenProp, defaultOpen = true, open: openProp, className, children, style, ...props }, ref) => {
...
>(({ collapsible = 'offcanvas', variant = 'sidebar', side = 'left', className, children, ...props }, ref) => {
...
>(({ variant = 'default', isActive = false, size = 'default', asChild = false, className, tooltip, ...props }, ref) => {
	const Comp = asChild ? Slot : 'button'
...
>(({ showOnHover = false, asChild = false, className, ...props }, ref) => {
	const Comp = asChild ? Slot : 'button'
