...
export default function OfferCounter({ count, sortValue, onSortChange }: OfferCounterProps) {
  let countLabel = ''
  if (count === 0) {
  ...
  return (
    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
      ...
      <Select value={sortValue} onValueChange={onSortChange}>
        <SelectTrigger className="w-full sm:w-48 border border-border text-foreground bg-card data-[placeholder]:!text-muted-foreground focus:border-accent focus:ring-accent placeholder:text-muted-foreground">
